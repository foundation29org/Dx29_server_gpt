...
const CostTrackingSchema = new Schema({
  ...
  model: {
    type: String,
    required: true,
    enum: ['gpt4o', 'o3', 'sonar', 'gpt5nano', 'gpt5mini', 'gpt54mini', 'gpt5', 'gemini-3-pro-preview', 'gemini-2.5-pro', 'sonar-reasoning-pro', 'sonar-pro', 'document_intelligence'],
    index: true
  },
  ...
  stages: [{
    ...
    model: {
      type: String,
      enum: ['gpt4o', 'o3', 'translation_service', 'sonar', 'gpt5nano', 'gpt5mini', 'gpt54mini', 'gpt5', 'gemini-3-pro-preview', 'gemini-2.5-pro', 'sonar-reasoning-pro', 'sonar-pro', 'document_intelligence']
    },
    duration: {
